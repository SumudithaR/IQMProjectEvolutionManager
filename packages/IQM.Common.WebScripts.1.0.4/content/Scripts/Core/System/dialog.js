...
*/
Dialog.LoadAjaxResults = function (inputOptions) {
    var options =
    {
        url: '',
        page: 1,
            ...
            if (data.Results.length > 0) {
                ...
                if (data.HasPrev)
                {
                    ...
                    $("#dialog_Prev").click(function () {
                        ...
                        Dialog.LoadAjaxResults(options);
                    });
                    $("#dialog_Prev").show();
                }
                else {
...
*/
Dialog.Prepare = function (inputOptions) {
...
*/
Dialog.SetupHelp = function (dialog, subject, topic) {
    ...
    helpButton.click(function () {
        ...
        Help.Show(urlOffset + '/Help/AjaxDetail/' + subject + '/' + topic);
    });
};