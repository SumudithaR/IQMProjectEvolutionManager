...
{
    public class ReleaseWorkLogDomainWrapper : BaseViewModel<ReleaseWorkLog>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseTypeDomainWrapper"/> class.
        /// </summary>
        public ReleaseWorkLogDomainWrapper() : base(new ApplicationSettings())
        {
        }
