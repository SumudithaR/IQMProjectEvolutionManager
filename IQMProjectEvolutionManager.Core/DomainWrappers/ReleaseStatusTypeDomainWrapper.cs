...
{
    public class ReleaseStatusTypeDomainWrapper : BaseViewModel<ReleaseStatusType>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ReleaseStatusTypeDomainWrapper"/> class.
        /// </summary>
        public ReleaseStatusTypeDomainWrapper()
        ...
        {
            return Data.ReleaseStatusTypeId;
        }
    }
}