...
{
    public class SubscriberNotifierPagedSearchDomainWrapper : PagedSearchViewModel<SubscriberNotifier>
    {
        public SubscriberNotifierPagedSearchDomainWrapper()
        ...
        {
            return new SubscriberNotifierPagedSearchDomainWrapper();
        }
    }
}
