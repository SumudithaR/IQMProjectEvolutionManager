...
{
    public class UserNotifierProviderPagedSearchDomainWrapper : PagedSearchViewModel<UserNotifierProvider>
    {
        public UserNotifierProviderPagedSearchDomainWrapper()
        ...
        {
            return new UserNotifierProviderPagedSearchDomainWrapper();
        }
    }
}
