...
{
    public class ReleaseWorkLogPagedSearchDomainWrapper : PagedSearchViewModel<ReleaseWorkLog>
    {
        public ReleaseWorkLogPagedSearchDomainWrapper() : base(new ApplicationSettings())
        {
        }

        public override object CopyModel()
        {
            return new ReleaseWorkLogPagedSearchDomainWrapper();
        }
    }
}
