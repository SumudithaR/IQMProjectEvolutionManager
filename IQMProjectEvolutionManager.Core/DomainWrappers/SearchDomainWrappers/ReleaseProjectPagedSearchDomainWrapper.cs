...
{
    public class ReleaseProjectPagedSearchDomainWrapper : PagedSearchViewModel<ReleaseProject>
    {
        public ReleaseProjectPagedSearchDomainWrapper() : base(new ApplicationSettings())
        {
        }

        public override object CopyModel()
        {
            return new ReleaseProjectPagedSearchDomainWrapper();
        }
    }
}