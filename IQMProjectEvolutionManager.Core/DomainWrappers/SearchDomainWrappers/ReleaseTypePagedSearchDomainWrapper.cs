...
{
    public class ReleaseTypePagedSearchDomainWrapper : PagedSearchViewModel<ReleaseType>
    {
        public ReleaseTypePagedSearchDomainWrapper()
        ...
        {
            return new ReleaseTypePagedSearchDomainWrapper();
        }
    }
}