...
{
    public class ReleaseStatusTypePagedSearchDomainWrapper : PagedSearchViewModel<ReleaseStatusType>
    {
        public ReleaseStatusTypePagedSearchDomainWrapper()
        ...
        {
            return new ReleaseStatusTypePagedSearchDomainWrapper();
        }
    }
}