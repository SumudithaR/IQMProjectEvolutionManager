...
{
    public class TaskPagedSearchDomainWrapper : PagedSearchViewModel<Task>
    {
        public TaskPagedSearchDomainWrapper() : base(new ApplicationSettings())
        {
        ...
        {
            return new TaskPagedSearchDomainWrapper();
        }
    }
}
